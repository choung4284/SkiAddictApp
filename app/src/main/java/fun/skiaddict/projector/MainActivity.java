...
public class MainActivity extends Activity {
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        root.setBackgroundColor(Color.rgb(240, 247, 252));
        ...
        master.setAdjustViewBounds(false);
        master.setBackgroundColor(Color.rgb(240, 247, 252));

        root.addView(master, new FrameLayout.LayoutParams(
